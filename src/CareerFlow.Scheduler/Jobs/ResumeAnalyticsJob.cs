...
public class ResumeAnalyticsJob : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        try
        {
            ...
            var analyticsList = await dbContext.ResumeAnalytics
                .Include(a => a.Person)
