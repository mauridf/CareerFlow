        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiplomaPath = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicBackgrounds_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfessionalExperiences_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfessionalExperienceId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkillExperiences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkillExperiences_ProfessionalExperiences_ProfessionalExperi~",
                        column: x => x.ProfessionalExperienceId,
                        principalTable: "ProfessionalExperiences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SkillExperiences_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicBackgrounds_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalExperiences_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkillExperiences_ProfessionalExperienceId",
                table: "SkillExperiences",
                column: "ProfessionalExperienceId");

            migrationBuilder.CreateIndex(
                name: "IX_SkillExperiences_SkillId_ProfessionalExperienceId",
                table: "SkillExperiences",
                columns: new[] { "SkillId", "ProfessionalExperienceId" },
                unique: true);
